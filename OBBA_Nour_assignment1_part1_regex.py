...
Original file is located at
    https://colab.research.google.com/drive/1mLQYg207owo16baxn4lfkhCoe2jqsIZK
...
def question_two():
    """
    Extract all dates with month names.
    """
...
def question_seven():
    ...
    for i, note in enumerate(df):
        ...
        extracted_dates.append((i, date))

    df_dates = pd.DataFrame(extracted_dates, columns=["index", "date"])
    df_dates = df_dates.sort_values("date")

    return pd.Series(df_dates["index"].values)
