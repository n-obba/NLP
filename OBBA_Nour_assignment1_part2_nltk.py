...
Original file is located at
    https://colab.research.google.com/drive/1lWEe5S0OdgL-js8f3WbyIwd_kk3D_s0i
...
def question_four():
    ...
    tokens = [token for token in freq if len(token) > 5 and freq[token] > 150]
...
def question_six():
    ...
    results = [(freq[word], word) for word in freq if word.isalpha() and freq[word] > 2000]
